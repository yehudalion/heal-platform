...
| **T-CAL-V4-L2** | **P0** | M | **מנת כיול ראשונה של v4 — 10 פריטים** [בתהליך, נוסחה 14.7.2026] — recipe `CAL-V4-L2`, רמה 2. תיוג מלא לפי v4: `mechanism_1/2/3` (R1,R2,R3,R5,R6,R7,R9), `proximity_1/2/3` (P1/P2/P3), `transformations` (G1–G9), `relation_count`, `hard_word_count`. `is_published=false` עד אישור מפורש של Lion. מכייל את המחולל מול קורפוס האמת (`docs/truth_corpus/`) לפני ייצור בקנה מידה. | DB `restatement_questions`, `docs/עד הפטור_Rephrase_Master_Plan_v4_2026-07-14.md` |
