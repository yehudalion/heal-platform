...
.lt-fallback {
  ...
  border: 1px solid var(--border, #E0EBE4);
...
.lt-url-input:focus { border-color: var(--green, #4CAF6F); }
.lt-url-btn {
  padding: 10px 18px;
  background: var(--green, #4CAF6F);
  color: #fff;
  border: none;
  border-radius: var(--radius-sm, 10px);
  font-size: 0.82rem;
...
.lt-status-err { color: var(--red, #e53935); font-size: 0.82rem; }
.lt-status-ok  { color: var(--green, #4CAF6F); font-size: 0.82rem; }
</style>
`;
