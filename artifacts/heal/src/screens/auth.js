...
const STEPS = [
  { n: '1', t: 'אבחון והתאמה לצרכים האישיים שלך', s: 'במבנה הבחינה, עם טיימר לכל פרק. בסוף — לא ציון עירום אלא דוח: איפה אתם חזקים ואיפה הפער, ותוכנית שנבנית סביבו.' },
  ...
  root.innerHTML = `
    <div class="ld fade-in">
      ...
      <section class="ld-hero">
        ...
        <h1 class="ld-h1">הרף לפטור הוא <span class="ld-134">134</span>.<br>אנחנו לוקחים אתכם עד לשם.</h1>
        <p class="ld-lead">
      ...
      <section class="ld-sec ld-founder">
        <div class="ld-founder-card">
          ...
          <p>
            אני יהודה. ניגשתי לפסיכומטרי בעצמי וקיבלתי 790, ומאז חמש שנים אני מלמד פסיכומטרי,
            כולל חלק האנגלית. חקרתי את המבחן לעומק — כל סוג שאלה, כל דפוס שחוזר — וראיתי את אותה
      ...
      <section class="ld-final">
        ...
        <p>אבחון והתאמה לצרכים האישיים שלכם ייתנו את התשובה, ואת התוכנית שמביאה אתכם מעליו.</p>
        <button class="btn-google btn-start ld-primary" type="button" data-google>
          ${googleIcon}
          להתחיל לתרגל עם Google — בחינם
        </button>
