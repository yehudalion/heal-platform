...
const IOS = () => `
  <ol class="ip-steps">
    <li><span>פותחים את <b>olimrama.co.il</b> ב-<b>Safari</b> (לא בכרום — באייפון רק ספארי יודע להוסיף למסך הבית).</span></li>
...
const ANDROID = `
  <ol class="ip-steps">
    <li><span>פותחים את <b>olimrama.co.il</b> ב-<b>Chrome</b>.</span></li>
