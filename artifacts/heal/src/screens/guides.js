 ...
 *
 * תשעת עמודי ההסבר חיים תחת `public/` כ-HTML סטטי, מחוץ ל-SPA. הם נבנו
...
export const GUIDES = [
  ...
  {
    href:  '/nisuach-mechadash/',
    title: 'ניסוח מחדש — איך ניגשים',
    desc:  'ארבעת הדפוסים שתופסים את רוב הנבחנים, ואיך מזהים אותם בזמן אמת.',
  },
  {
    href:  '/ptor-anglit/',
    featured: true,
