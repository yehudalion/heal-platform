...
**עד הפטור** — a Hebrew-language prep platform for the **HILAL** English exam (the section
...
| `docs/עד הפטור_Rephrase_Master_Plan_v4_2026-07-14.md` | Rephrase module — the v4 taxonomy (R/P/G). |
